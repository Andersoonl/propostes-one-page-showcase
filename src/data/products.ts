...
export const productCategories: ProductCategory[] = [
  {
    ...
    icon: Box,
    products: [
      { name: "Bloco de Vedação", dimensions: "9x19x39", image: blocoVedacao9x19x39, specs: { resistencia: "3MPa", largura: "9cm", altura: "19cm", comprimento: "39cm" }, description: "Indicado para paredes internas e externas de vedação, com bom rendimento por m² e modulação prática. Ideal para divisórias e fechamentos onde a parede não trabalha como elemento estrutural.", calculatorRef: "blocos:bloco-9" },
  ...
  },
  {
    ...
    icon: Box,
    products: [
      { name: "Bloco Estrutural", dimensions: "19x19x39", image: blocoEstrutural19x19x39, specs: { resistencia: "6MPa", largura: "19cm", altura: "19cm", comprimento: "39cm" }, description: "Indicado para alvenaria estrutural e paredes com maior exigência de desempenho e robustez, conforme dimensionamento do projeto. Adequado para obras que pedem maior espessura e estabilidade.", calculatorRef: "blocos:bloco-19" },
  ...
  },
  {
    ...
    icon: Grid3X3,
    products: [
      { name: "Piso Retangular", dimensions: "H4", image: pisoRetangularH4, specs: { resistencia: "35MPa", altura: "4cm", tipo: "Retangular" }, description: "Indicado para áreas de passeio e uso leve, com visual tradicional e assentamento simples. Boa escolha para calçadas e áreas internas externas de baixo tráfego.", calculatorRef: "pisos:retangular-h4" },
      { name: "Piso Retangular", dimensions: "H6", image: pisoRetangularH6, specs: { resistencia: "35MPa", altura: "6cm", tipo: "Retangular" }, description: "Versátil para calçadas, condomínios e áreas com tráfego leve a moderado. Combina bom custo-benefício com resistência adequada para a maioria das áreas comuns.", calculatorRef: "pisos:retangular-h6" },
      { name: "Piso Retangular", dimensions: "H8", image: pisoRetangularH8, specs: { resistencia: "35MPa", altura: "8cm", tipo: "Retangular" }, description: "Recomendado para áreas com maior solicitação, como estacionamentos, vias internas e acessos com veículos. Maior espessura para melhor desempenho em tráfego mais intenso.", calculatorRef: "pisos:retangular-h8" },
      { name: "Piso Unistein", dimensions: "H6", image: pisoUnisteinH6, specs: { resistencia: "35MPa", altura: "6cm", tipo: "Unistein" }, description: "Formato que melhora o travamento entre peças, indicado para tráfego leve a moderado com mais estabilidade. Ótima opção para áreas de manobra e locais com esforços horizontais.", calculatorRef: "pisos:unistein-h6" },
      { name: "Piso Unistein", dimensions: "H8", image: pisoUnisteinH8, specs: { resistencia: "35MPa", altura: "8cm", tipo: "Unistein" }, description: "Indicado para estacionamentos e vias internas com tráfego mais intenso, com excelente intertravamento. Ajuda a reduzir deslocamentos das peças ao longo do tempo.", calculatorRef: "pisos:unistein-h8" },
      { name: "Piso Unistein", dimensions: "H10", image: pisoUnisteinH10, specs: { resistencia: "35MPa", altura: "10cm", tipo: "Unistein" }, description: "Aplicação em áreas de tráfego pesado e alta solicitação, conforme projeto de base e sub-base. Ideal para pátios operacionais, acessos de caminhões e áreas industriais.", calculatorRef: "pisos:unistein-h10" },
      { name: "Piso Citypalc", dimensions: "Padrão", image: pisoCitypalc, specs: { resistencia: "35MPa", tipo: "Citypalc" }, description: "Acabamento mais decorativo, indicado para áreas urbanas, calçadas e praças, valorizando o visual da paginação. Une estética e praticidade de manutenção do intertravado.", calculatorRef: "pisos:cityplac" },
      { name: "Pisograma", dimensions: "H8", image: pisograma, specs: { resistencia: "35MPa", altura: "8cm", tipo: "Gramado" }, description: "Piso vazado/gradeado para áreas que combinam resistência e integração com paisagismo, permitindo uso com grama ou brita. Indicado para estacionamentos verdes e áreas de drenagem superficial.", calculatorRef: "pisos:pisograma" },
    ],
  },
  {
