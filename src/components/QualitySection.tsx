...
const QualitySection = () => {
  return (
    <section id="qualidade" className="py-20 md:py-28 bg-concrete-dark text-white">
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left Content */}
          <div>
            <p className="text-primary font-medium mb-3">Certificação</p>
              ...
              {certifications.map((cert, index) => (
                ...
                >
                  <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
                    <cert.icon size={20} className="text-primary-foreground" />
                  </div>
                  <div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              {/* Badge Container */}
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/20 rounded-3xl p-10 md:p-14 text-center hover:border-primary/50 transition-all duration-500 hover:scale-105">
                <div className="w-24 h-24 md:w-32 md:h-32 bg-primary rounded-full flex items-center justify-center mx-auto mb-6">
                  <Award size={48} className="text-primary-foreground md:w-16 md:h-16" />
                </div>
                
                <h3 className="text-2xl md:text-3xl font-bold mb-2">ISO 9001</h3>
                <p className="text-primary font-medium text-lg mb-4">Certificado de Qualidade</p>
